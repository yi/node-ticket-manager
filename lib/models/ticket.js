...
(function() {
  ...
  TicketSchema.statics.addComment = function(id, name, type, content, callback) {
    var comment;
    if (!((id != null) && (name != null) && (type != null) && (content != null) && (callback != null))) {
    ...
    this.findById(id, function(err, ticket) {
      ...
      if (ticket == null) {
        callback(new Error("missing ticket " + id));
      }
