...
(function() {
  var app, config, configs, debuglog, env, err, exports, express, externalConfig, fs, mongoose, p, path, pathToExternalConfig, port, _;
  ...
  p.version('0.0.1').option('-c, --config [VALUE]', 'path to config file').option('-p, --port [VALUE]', 'port to run this web service').option('-e, --environment  [VALUE]', 'application environment mode').parse(process.argv);
