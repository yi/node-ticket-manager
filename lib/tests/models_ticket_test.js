...
(function() {
  var SAMPLE_CONTENT_1, SAMPLE_TITLE_1, SAMPLE_TITLE_2, STATUS, Ticket, config, mongoose, should;
  ...
  describe("test", function() {
    ...
    return describe("models/ticket", function() {
      ...
      return it("should able to process a pending ticket", function(done) {
        return Ticket.changeStatus({
          title: SAMPLE_TITLE_2
